...
namespace Manager.Application.Configuration.MultiTenancy
{
    ...
    public class TenantAppService : ManagerAppServiceBase, ITenantAppService
    {
        ...
        public async Task CreateTenant(CreateTenantInput input)
        {
            ...
            using (CurrentUnitOfWork.SetTenantId(tenant.Id))
            {
                ...
                var adminUser = User.CreateTenantUser(tenant.Id, StaticRoleNames.Tenants.Admin, input.AdminEmailAddress, User.DefaultPassword);
